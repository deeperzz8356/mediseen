...
const mr = {
  ...en,
  splash: { tagline: "क्लिनिकल स्टुडिओ" },
  getStarted: {
    ...en.getStarted,
    badge: "वैद्यकीय निर्णयांना बळ देणे",
    headline: "आरोग्य विश्लेषण,\nनव्या रूपात.",
    subtitle: "तुमच्या वैद्यकीय अहवालांमधून आणि स्कॅनमधून त्वरित स्पष्ट, AI-आधारित अंतर्दृष्टी मिळवा.",
    cta: "सुरू करा",
  ...
  languageSelection: {
    ...
    title: "भाषा निवडा",
    subtitle: "अधिक चांगल्या वैद्यकीय अनुभवासाठी तुमची पसंतीची भाषा निवडा.",
  ...
  onboarding: {
    ...
    slides: {
      ...
      cards: {
        aiDetection: {
          title: "AI रोग शोध",
          subtitle: "क्षणात वैद्यकीय माहिती",
          description: "कोणताही वैद्यकीय स्कॅन किंवा अहवाल अपलोड करा आणि आमचा प्रगत AI तो काही सेकंदांत विश्लेषित करतो. स्पष्ट, सहज समजणारे निदान आणि विश्वास गुण मिळवा.",
          features: ["छातीच्या एक्स-रेचे विश्लेषण", "त्वचारोग शोध", "98% अचूकता"],
        },
        diet: {
          title: "आहार शिफारसी",
          subtitle: "तुमच्यासाठी अनुरूप पोषण",
          description: "तुमची निदान झालेली स्थिती, वय आणि आरोग्य उद्दिष्टांवर आधारित वैयक्तिक आहार योजना मिळवा. काय खावे आणि काय टाळावे हे अचूकपणे जाणून घ्या.",
        ...
        assistant: {
          title: "AI वैद्यकीय सहाय्यक",
          subtitle: "कधीही, काहीही विचारा",
          description: "अलीकडील वैद्यकीय ज्ञानाने समर्थित आमच्या AI वैद्यकीय सल्लागाराशी चॅट करा. तुमच्या निदान आणि उपचार पर्यायांबद्दल सविस्तर स्पष्टीकरण मिळवा.",
          features: ["२४/७ वैद्यकीय मार्गदर्शन", "बहुभाषिक समर्थन", "पुराव्यावर आधारित उत्तरे"],
        },
      },
    },
  },
  ...
  agent: {
    ...
    analyzing: "मी तुमचा प्रश्न क्लिनिकल मॉडेलसह विश्लेषित करत आहे...",
    placeholder: "मला काहीही विचारा...",
  },
  home: {
    ...en.home,
    badge: "तुमच्या वैद्यकीय निर्णयांना बळ",
    greeting: "नमस्कार,",
